...
OARSS 是一个开放规范，为 **AI workforce** 提供类似人力资源管理的框架，以**任务驱动（task-driven）、项目驱动（project-driven）**为核心，让 AI Agent 生态从“散乱的最佳实践集合”升级为**可切换的专业角色技能栈**。就像导演按剧本选角：任务/项目决定需要什么角色，再匹配能承担该角色的 Persona。
